 ...
 * [entities][E] within the given chessboard distance from this [Entity].
 * A null distance is assumed to be infinite.
 */
inline fun <reified E : Entity> Entity.hasNearbyEntitiesByTypeChessboardDistance(
	distance: Double?,
...
/**
 * @return Whether there exist
 * [entities][E] within the given chessboard distances from this [Entity].
...
/**
 * @return Whether there exist
 * [entities][E] within the given Euclidean distance from this [Entity].
 * A null distance is assumed to be infinite.
 */
inline fun <reified E : Entity> Entity.hasNearbyEntitiesByType(
	distance: Double?,
	noinline predicate: EntityByTypePredicate<E>? = null
...
/**
 * @return Whether there exist
 * [entities][E] within the given Euclidean distances from this [Entity].
 * Any null distance is assumed to be infinite.
 */
inline fun <reified E : Entity> Entity.hasNearbyEntitiesByType(
	xzDistance: Double?,
...
/**
 * @return Whether there exist
 * [entities][E] with the given Euclidean distances from this [Entity].
 * Any null distance is assumed to be infinite.
 */
inline fun <reified E : Entity> Entity.hasNearbyEntitiesByType(
	xzDistance: Double?,
...
/**
 * @return Whether there exist
 * [entities][E] within the given distance per axis from this [Entity].
 * Any null distance is assumed to be infinite.
 */
inline fun <reified E : Entity> Entity.hasNearbyEntitiesByType(
	xDistance: Double?,
