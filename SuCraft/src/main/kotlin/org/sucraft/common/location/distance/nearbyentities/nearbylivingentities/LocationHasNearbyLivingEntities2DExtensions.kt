 ...
 * [living entities][LivingEntity] within the given planar (xz) chessboard distance from this [Location].
 * A null distance is assumed to be infinite.
 */
fun Location.hasNearbyLivingEntitiesChessboardDistance2D(
	distance: Double?,
...
/**
 * @return Whether there exist
 * [living entities][LivingEntity] within the given planar (xz) Euclidean distance from this [Location].
 * A null distance is assumed to be infinite.
 */
fun Location.hasNearbyLivingEntities2D(
	distance: Double?,
	predicate: LivingEntityPredicate? = null
...
/**
 * @return Whether there exist
 * [living entities][LivingEntity] within the given distance per planar (xz) axis from this [Location].
