 ...
 * [entities][Entity] within the given planar (xz) chessboard distance from this [Location].
 * A null distance is assumed to be infinite.
 */
fun Location.hasNearbyEntitiesChessboardDistance2D(
	distance: Double?,
...
/**
 * @return Whether there exist
 * [entities][Entity] within the given planar (xz) Euclidean distance from this [Location].
 * A null distance is assumed to be infinite.
 */
fun Location.hasNearbyEntities2D(
	distance: Double?,
	predicate: EntityPredicate? = null
) = getNearbyEntities2D(
	distance,
...
/**
 * @return Whether there exist
 * [entities][Entity] within the given distance per planar (xz) axis from this [Location].
